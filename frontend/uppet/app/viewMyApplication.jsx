...
export default function ViewMyApplication(props) {
  ...
  const fetchPendingApplicants = async (lastCursorID, isRefreshing = false) => {
    ...
    try {
      ...
      const res = await api.get(`/api/adoptionApp/my/pending`, {
        params: {
  ...
  const fetchApprovedApplicants = async (
    ...
    try {
      ...
      const res = await api.get(`/api/adoptionApp/my/approved`, {
        params: {
  ...
  const fetchRejectedApplicants = async (
    ...
    try {
      ...
      const res = await api.get(`/api/adoptionApp/my/rejected`, {
        params: {
